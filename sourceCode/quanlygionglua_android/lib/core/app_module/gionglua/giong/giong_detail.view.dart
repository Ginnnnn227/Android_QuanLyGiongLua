...
import 'controller/field_list.controller.dart';
import 'controller/ptn_list.controller.dart';
        ...
        body: Stack(
          children: <Widget>[
            SizedBox(
              ...
              child: Image.network(
                "http://10.0.2.2:80/quanlyluagiong/storage/app/${data.giongHinhanh}"
                ...
                Obx(() {
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Text(
                        item.ptnCode!.isEmpty?"Chưa cập nhật":"${item.ptnCode}",
