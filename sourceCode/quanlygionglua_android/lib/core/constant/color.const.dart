...
const kPrimaryColor = Color.fromARGB(255, 254, 119, 0);//Color(0xFFFE9900);//FF7643

const kSecondaryColor = Color(0xFF979797);
const kTextColor01 = Color(0xFF757575);
const kTextColor02 = Colors.brown;

const Color primaryDark = Color(0xFF40ACA1);
const Color primaryLight = Color(0xFF6CDAFF);

const Color secondaryDark = Color(0xFF060581);
const Color secondaryDarkSelected = Color(0xFFFF1D00);
